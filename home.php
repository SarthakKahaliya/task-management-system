...
<div class="container">
  <hgroup>
    <h1 class="site-title" style="text-align: center; color: green;">Task Management System</h1>
  </hgroup>
</div>
...
<nav class="navbar navbar-inverse">
  <div style="display: flex; flex-direction: row; justify-content: space-between; align-items: start;">
    <div style="color: white; padding-left: 20px; padding-right: 0px; margin-top: -5px;">
